            ...
            <div class="col-xxl-8 col-lg-7">
              <div class="th-blog blog-single">
                ...
                <div class="blog-content">
                  <div class="blog-meta">
                    <a href="blog.html">
                      <i class="fa-light fa-user"></i> Michel Smith
                    </a>
                    <a href="blog.html">
                      <i class="fa-regular fa-calendar"></i> 24/02/2025
                    </a>
                    <a href="blog.html">
                      <i class="fa-regular fa-tag"></i> Business
                    </a>
                  </div>
                  <h2 class="blog-title">
                  ...
                  <span class="details-sub-title">
                    <span class="double-line"></span> Work Process
                  </span>
